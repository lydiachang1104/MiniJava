...
public class MiniJavaBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements MiniJavaVisitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFormalList(MiniJavaParser.FormalListContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitFormalMore(MiniJavaParser.FormalMoreContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitMethodArgumentList(MiniJavaParser.MethodArgumentListContext ctx) { return visitChildren(ctx); }
}